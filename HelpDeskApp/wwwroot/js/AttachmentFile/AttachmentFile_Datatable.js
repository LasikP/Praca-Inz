        ...
        "columns": [
            ...
            },
            {
                data: null, render: function (data, type, row) {
                    return "<a href='#' class='btn btn-success btn-xs' onclick=DownloadFile('" + row.Id + "'); >Pobierz</a>";
                }
            },
            {
                data: null, render: function (data, type, row) {
                    return "<a href='#' class='btn btn-danger btn-xs' onclick=Delete('" + row.Id + "'); >Usuñ</a>";
                }
            }
        ],
