    ...
    public class UserRoleController : Controller
    {
        ...
        public async Task<IActionResult> UpdateRole(UpdateRoleViewModel _UpdateRoleViewModel)
        {
            ...
            try
            {
                ...
                {
                    return new JsonResult("Użytkownik nie znaleziony");
                }
                ...
                if (!result.Succeeded)
                {
                    return new JsonResult("Nie można usunąć istniejących ról użytkownika");
                }
                ...
                if (!result.Succeeded)
                {
                    return new JsonResult("Nie można dodać wybranych ról do użytkownika");
                }
                _JsonResultViewModel.AlertMessage = "Aktualizacja roli pomyślna. Nazwa użytkownika: " + _ApplicationUser.Email;
