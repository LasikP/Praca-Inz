    ...
    public class UserProfileController : Controller
    {
        ...
        public async Task<IActionResult> EditUserProfile(UserProfileCRUDViewModel _UserProfileCRUDViewModel)
        {
            try
            {
                ...
                TempData["successAlert"] = "Informacje o użytkowniku Zaktualizowano pomyślnie. Nazwa użytkownika: " + _UserProfileCRUDViewModel.Email;
        ...
        public async Task<IActionResult> ResetPassword(ResetPasswordVM vm)
        {
            ...
            if (vm.NewPassword.Equals(vm.ConfirmPassword))
            {
                ...
                if (result.Succeeded)
                    TempData["successAlert"] = "Zmiana hasła powiodła się. Nazwa użytkownika: " + _ApplicationUser.Email;
                else
                {
