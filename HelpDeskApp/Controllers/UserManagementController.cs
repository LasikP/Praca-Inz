        ...
        public async Task<JsonResult> AddEditUserAccount(UserProfileCRUDViewModel _UserProfileCRUDViewModel)
        {
            ...
            try
            {
                if (_UserProfileCRUDViewModel.UserProfileId > 0)
                {
                    ...
                    _JsonResultViewModel.AlertMessage = "Informacje o użytkowniku Zaktualizowano pomyślnie. Nazwa użytkownika: " + _UserProfile.Email;
                ...
                else
                {
                    ...
                    if (_ApplicationUser.Item2 == "Success")
                    {
                        ...
                        _JsonResultViewModel.AlertMessage = "Użytkownik został utworzony pomyślnie. Nazwa użytkownika: " + _ApplicationUser.Item1.Email;
                        _JsonResultViewModel.CurrentURL = _UserProfileCRUDViewModel.CurrentURL;
                        _JsonResultViewModel.IsSuccess = true;
                        return new JsonResult(_JsonResultViewModel);
                    }
                    ...
                    {
                        _JsonResultViewModel.AlertMessage = "Tworzenie użytkownika nie powiodło się." + _ApplicationUser.Item2;
            ...
            try
            {
                ...
                if (vm.NewPassword.Equals(vm.ConfirmPassword))
                {
                    ...
                    if (_ResetPasswordAsync.Succeeded)
                        AlertMessage = "Resetowanie hasła powiodło się. Nazwa użytkownika: " + _ApplicationUser.Email;
                    else
                    {
                        ...
                        AlertMessage = "błąd Resetowanie hasła nie powiodło się." + errorMessage;
                    }
                }
